...
from models.policy_rule import PolicyRuleSchema as ModelSchema, PolicyRule as Model, GetPolicyRuleSchema as GetModelSchema
from common.util import Util


class PolicyRule(Resource):
    #api-policy_rules-get-by-id
...
class PolicyRuleListSearch(Resource):
    #api-policy_rules-get-all
    # @base.access_middleware
    def get(self):
        try:
