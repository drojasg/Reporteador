...
from models.age_code import AgeCodeSchema as ModelSchema, AgeCode as Model
from common.util import Util


class AgeCode(Resource):
    #api-age-code-get-by-id
...
class AgeCodeListSearch(Resource):
    #api-age-code-get-all
    #@base.access_middleware
    def get(self):
        try:
