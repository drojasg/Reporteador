...
from resources.media_banners.media_banners_service import MediaBannersService
...
class EmailTemplate(Resource):
    ...
    def get(self, booking_data):
        self.get_banners(booking_data)
        return self.getHTML(self.getSecciones(booking_data))
    
    def get_banners(self,booking_data):
        getMediaBanner = MediaBannersService()
        fecha_creacion = booking_data["fecha_creacion"]
        fecha_creacion = fecha_creacion.split()
        booking_window = fecha_creacion[0]

        info_heads_footers = getMediaBanner.get_heads_and_footers_letter(lang_code=booking_data["lang_code"].upper(),\
        market_code=booking_data["country_code"],booking_window=booking_window,property_code=booking_data["property_code"],\
        brand_code=booking_data["brand_code"])
        self.banners = info_heads_footers
    ...
    def getImg(self, brand, property, lang):
        ...
        images = {
            "imgHeader": self.banners["heads"] if self.banners != None else [],
            "imgFooter": self.banners["footers"] if self.banners != None else [],
    ...
    def getInfoGuestCancel(self, booking_data):
        ...
        htmlGuest = "<tr><td style='width: 100%; text-align: center;'><table style='width: 100%;'><tr><td style='width: 50%;'><div> <span style='color: "+booking_data["color"]["base"]+"; font-weight: bold; font-size: 22px;'> "+booking_data["traslate"]["tx_title_cancelation"]+" </span>" +\
                    ...
                    "<span style='color: #848484;'>"+booking_data["traslate"]["Tx_total_room"]+": </span>"+str(booking_data["total_rooms"])+"</div><div style='height: 8px;'></div></td></tr></table></td></tr></table><table style='width: 100%; max-width: 290px; display: inline-block; vertical-align: top;'>" +\
                    ...
                    "</div></div></td></tr><tr><td><div style='text-align: left;width: 284px; font-size: 12px;'><span style='color: #848484;'> "+booking_data["traslate"]["refund_Process_tres"]+"</span></div></td></tr></table>      <table><tr><td> </td></tr><tr><td> </td></tr><tr><td> </td></tr><tr><td> </td></tr></table>" +\
    ...
    def getImagesFooter(self, booking_data):
        footerImages = "<tr><td style='width: 100%;'><table style='width: 100%;'><tbody><tr><td style=' text-align: center;'><table style='width: 100%; max-width: 600px; display: inline-block; vertical-align: top;'><tbody><tr><td style='width: 100%;'><table><tbody></tbody></table></td></tr></tbody></table></td></tr></tbody></table></td></tr>"
        if len(booking_data["images"]["imgFooter"]) > 0:
            footerImages = "<tr><td style='width: 100%;'><table style='width: 100%;'><tbody><tr><td style=' text-align: center;'><table style='width: 100%; max-width: 600px; display: inline-block; vertical-align: top;'><tbody><tr><td style='width: 100%;'><table><tbody> "
            for item in booking_data["images"]["imgFooter"]:
                footerImages += "<tr><td><div> <a href='"+item["href_banner"]+"'><img src='"+item["url_img"]+"' style='width: 100%;'></a> </div><div style='height: 15px;'></div></td></tr>"
            footerImages += "</tbody></table></td></tr></tbody></table></td></tr></tbody></table></td></tr>"
    ...
    def getHeader(self, booking_data):
        header = "<tr><td style='width: 100%;'></td></tr>"
        if len(booking_data["images"]["imgHeader"]) > 0:
            header = "<tr><td style='width: 100%;'> <img src='"+booking_data["images"]["imgHeader"][0]+"' style='width: 100%;'></td></tr>"
        return header
