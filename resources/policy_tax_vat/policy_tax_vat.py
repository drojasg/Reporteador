...
from models.policy_tax_vat import PolicyTaxVatSchema as ModelSchema, PolicyTaxVat as Model, GetPolicyTaxVatSchema as GetModelSchema
from common.util import Util


class PolicyTaxVat(Resource):
    #api-policy_tax_vats-get-by-id
...
class PolicyTaxVatListSearch(Resource):
    #api-policy_tax_vats-get-all
    # @base.access_middleware
    def get(self):
        try:
