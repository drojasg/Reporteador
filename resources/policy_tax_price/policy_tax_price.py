...
from models.policy_tax_price import PolicyTaxPriceSchema as ModelSchema, PolicyTaxPrice as Model, GetPolicyTaxPriceSchema as GetModelSchema
from common.util import Util


class PolicyTaxPrice(Resource):
    #api-policy_tax_prices-get-by-id
...
class PolicyTaxPriceListSearch(Resource):
    #api-policy_tax_prices-get-all
    # @base.access_middleware
    def get(self):
        try:
