...
from models.policy_category import PolicyCategorySchema as ModelSchema, PolicyCategory as Model, GetPolicyCategorySchema as GetModelSchema
from common.util import Util


class PolicyCategory(Resource):
    #api-policy_categories-get-by-id
    ...
    def put(self, id):
        ...
        try:
            ...
            if request.json.get("help_text") != None:
                model.help_text = data["help_text"]
            if request.json.get("has_config") != None:
                model.has_config = data["has_config"]
            if request.json.get("options") != None:
...
class PolicyCategoryListSearch(Resource):
    #api-policy_categories-get-all
    # @base.access_middleware
    def get(self):
        try:
    ...
    def post(self):
        ...
        try:
            ...
            #model.id_def_policy_category = data["id_def_policy_category"]
