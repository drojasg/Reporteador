...
from models.policy_guarantee_type import PolicyGuaranteeTypeSchema as ModelSchema, PolicyGuaranteeType as Model, GetPolicyGuaranteeTypeSchema as GetModelSchema
from common.util import Util


class PolicyGuaranteeType(Resource):
    #api-policy_guarantee_types-get-by-id
...
class PolicyGuaranteeTypeListSearch(Resource):
    #api-policy_guarantee_types-get-all
    # @base.access_middleware
    def get(self):
        try:
