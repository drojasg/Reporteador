...
from models.contact_type import ContactTypeSchema as ModelSchema, ContactType as Model
from common.util import Util


class ContactType(Resource):
    #api-contact-types-get-by-id
...
class ContactTypeListSearch(Resource):
    #api-contact-types-get-all
    # @base.access_middleware
    def get(self):
        try:
