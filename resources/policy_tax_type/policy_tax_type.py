...
from models.policy_tax_type import PolicyTaxTypeSchema as ModelSchema, PolicyTaxType as Model, GetPolicyTaxTypeSchema as GetModelSchema
from common.util import Util


class PolicyTaxType(Resource):
    #api-policy_tax_types-get-by-id
...
class PolicyTaxTypeListSearch(Resource):
    #api-policy_tax_types-get-all
    # @base.access_middleware
    def get(self):
        try:
