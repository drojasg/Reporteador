...
from models.address import AddressSchema as ModelSchema, Address as Model
from common.util import Util


class Address(Resource):
    #api-addresses-get-by-id
    ...
    def put(self, id):
        ...
        try:
            ...
            model.state_code = data["state_code"]
...
class AddressListSearch(Resource):
    #api-addresses-get-all
    #@base.access_middleware
    def get(self):
        try:
