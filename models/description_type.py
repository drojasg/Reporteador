...
class  DescriptionType(db.Model):
    __tablename__="def_description_type"

    iddef_description_type = db.Column(db.Integer, primary_key=True)
...
class  DescriptionTypeSchema(ma.Schema):
